...
<head>
<meta charset="UTF-8">
<title>GrafanaProbe Report — ${escapeHtml(report.id || '')}</title>
<style>
...
<div class="container">
  <div class="header">
    <h1 class="brand">GrafanaProbe Report</h1>
  ...
  <div class="footer">Generated by GrafanaProbe v2 · by Gopal Rao</div>
</div>
...
app.get('/api/snapshots/:id/export', async (req, res) => {
  try {
    ...
    const filename = `grafanaprobe-snapshot-${safeName}-${snap.id.slice(0, 8)}.zip`;
